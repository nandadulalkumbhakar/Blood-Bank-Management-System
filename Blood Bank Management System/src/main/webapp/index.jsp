...
<body>
  ...
  {
	  %>
	  <center><font color="red" size="5">Form Submitted Successully. You will get notified within 24 hours.</center>
  <%
  }
  %>
   <%
  ...
  %>
 <center><h1>Enter Your Details to Requesr for Blood</h1></center>
